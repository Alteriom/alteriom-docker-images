...
if [[ -f "docs/security/SECURITY.md" ]]; then
    print_status "SUCCESS" "Security Policy (docs/security/SECURITY.md) - $(wc -l < docs/security/SECURITY.md) lines"
...
echo "  • Repository Security tab: https://github.com/Alteriom/alteriom-docker-images/security"
...
echo "  cat docs/security/SECURITY.md              # Security policy"
...
echo "  1. Review security policy: cat docs/security/SECURITY.md"
...
echo ""
print_status "INFO" "For questions or security concerns, see docs/security/SECURITY.md for reporting procedures"